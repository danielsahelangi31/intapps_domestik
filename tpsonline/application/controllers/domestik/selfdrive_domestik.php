...
class Selfdrive_Domestik extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $selfmod = model('domestik/selfdrive_model_domestik');
        $cat = $mod->getCategory();
        $vin = $selfmod->getVin();
        ...
        $this->load->view('domestik/backend/pages/eticket/selfdrive/index', $data);
    }
    ...
    public function getSearchVin() 
    {
        ...
        $response = $selfmod->getSearchVin($this->userauth->getLoginData()->sender, $searchTerm);
    ...
    {
        $this->load->model('domestik/selfdrive_model_domestik');
        $data = $this->selfdrive_model_domestik->getDataSelf();
    ...
    public function getSelfdriveModel()
    {

        $mod = model('domestik/selfdrive_model_domestik');
    ...
    {
        $this->load->model('domestik/selfdrive_model_domestik'); 
        $data = $this->selfdrive_model_domestik->getVinOutbound(); 
        echo json_encode($data); 
    }
    ...
    public function getShippingLine()
    {
        ...
        $mod = model('domestik/selfdrive_model_domestik');
        $searchTerm = $this->input->post('searchTerm');
        $response = $mod->getShippingLine($searchTerm);
    ...
    {
        $mod = model('domestik/selfdrive_model_domestik');
        $response = $mod->insert_self_drive();
        return $response;
    }
}
