<?php
/** Form Monitoring BM Domestik
  *	Modul untuk menyimpan dan edit data monitoring BM domestik tiap kapal
  *
  */
				...
				if($val->run()==TRUE){
					...
					//CALCULATE ET-BT
					   ...
					   $tbt = date("Y-m-d H:i:s",strtotime($time1)+$secs);
						...
						//USH						
						$ush = (60/($etH*60+$etI))*$total;
						if ($ush == INF || $ush_gross == NaN || $ush_gross == NAN ){
							$ush = 0;
						}
						$ush = ceil($ush);
