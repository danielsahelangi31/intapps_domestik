...
class Domestik_outbound extends CI_Controller {
    ...
    public function index() {
        redirect('tps_online/domestik_outbound/listview');
    }
    ...
    public function listview() {
        ...
        $mod = model('tps_online/domestik_outbound_model');
        ...
        $this->load->view('backend/pages/tps_online/domestik_outbound/listview', $data);
    }
    ...
    public function view($id = NULL) {
        ...
        if (!$grid_state) {
            $grid_state = 'tps_online/domestik_outbound/listview';
        }
        ...
        if ($row = $mod->get($id)) {
            ...
            $this->load->view('backend/pages/tps_online/domestik_outbound/view', $view);
        } else {
            redirect('tps_online/domestik_outbound/listview/404');
        }
    }
    ...
    public function finalize($id = NULL) {
        ...
        $mod = model('tps_online/domestik_outbound_model');
        $kargo = model('tps_online/cargo_domestik_outbound_model');
        ...
        if ($row = $mod->get($id)) {
            ...
            $this->load->view('backend/pages/tps_online/domestik_outbound/finalize', $view);
        } else {
            redirect('tps_online/domestik_outbound/listview/404');
        }
    }
