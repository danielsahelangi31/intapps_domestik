<?php
/** Input Manual RKAP Pendapatan
  *	Modul untuk menambahkan input manual RKAP pendapatan berdasarkan tahun dan terminal
  *
  */

class rkap_pendapatan extends CI_Controller{
	private $local_db;
	
	public function __construct(){
		parent::__construct();
		$this->load->model(array('tps_online/Model_rkap_pendapatan'
	...
	public function index(){
		redirect('tps_online/rkap_pendapatan/listview');
	}
	...
	public function listview(){	
        ...
        $mod = model('tps_online/Model_rkap_pendapatan');
		...
		$this->load->view('backend/pages/tps_online/rkap_pendapatan/listview',$data);
	}
    ...
    public function view($id = NULL) {
        ...
        if (!$grid_state) {
            ...
            $grid_state = 'tps_online/rkap_pendapatan/listview';
        }
        ...
        if ($row = $mod->get($id)) {
            ...
            $view['kunjung'] = $row;
            $this->load->view('backend/pages/tps_online/rkap_pendapatan/view', $view);
        }
    ...
    public function get($token = NULL) {
  	  ...
  	  public function new() {
            ...
            $this->load->view('backend/pages/tps_online/rkap_pendapatan/new', $view);
	...
	public function finalize($id = NULL, $voyage = NULL) {
        ...
        if (!$grid_state) {
            $grid_state = 'tps_online/rkap_pendapatan/finalize';
        }
		...
		$out->databm=$databm;
		 ...
		 $view = array(			
            ...
            $this->load->view('backend/pages/tps_online/rkap_pendapatan/finalize', $view);
