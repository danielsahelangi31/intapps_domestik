...
class Internasional_inbound extends CI_Controller {
    ...
    public function listview() {
        ...
        $mod = model('tps_online/internasional_inbound_model');
        ...
        $this->load->view('backend/pages/tps_online/internasional_inbound/listview', $data);
    }
    ...
    public function view($id = NULL) {
        ...
        if (!$grid_state) {
            $grid_state = 'tps_online/internasional_inbound/listview';
        }
...
//                $row->OUTWARD_BC11_DATE = post('OUTWARD_BC11_DATE');
            ...
            $this->load->view('backend/pages/tps_online/internasional_inbound/view', $view);
        } else {
    ...
    public function finalize($id = NULL) {
        ...
        $mod = model('tps_online/internasional_inbound_model');
        $kargo = model('tps_online/cargo_internasional_inbound_model');
...
//                $row->OUTWARD_BC11_DATE = post('OUTWARD_BC11_DATE');
            ...
            $this->load->view('backend/pages/tps_online/internasional_inbound/finalize', $view);
        } else {
            redirect('tps_online/internasional_inbound/listview/404');
        }
    }
    ...
    public function summary_detail($visit_id)
    {
        ...
        if ($data) {
            ...
            $params['data'] = $data;
            $this->load->view('backend/pages/tps_online/internasional_inbound/summary_detail', $params);
        } else {
            redirect('tps_online/internasional_inbound/listview/404');
        }
    }
