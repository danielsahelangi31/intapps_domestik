<?php
class Edit_bl extends CI_Controller{
	private $local_db;
	...
	public function index(){
		...
		$this->load->view('backend/pages/tps_online/bl/edit',$data);
	}
	...
	public function simpan($token){
        ...
        $db = $this->get_db();
        $edit_bl = model('tps_online/bl_model');
		$edit_bl->set_db($db);
		$edit_bl->update(post("bl_lama"));
	...
	public function view($id = NULL){
		...
		if($row = $mod->get($id,$sppb_number)){
			...
			$this->load->view('backend/pages/tps_online/bl/edit', $view);
		}else{
