...
class Domestik_inbound extends CI_Controller {
    ...
    public function index() {
        redirect('tps_online/domestik_inbound/listview');
    }
    ...
    public function listview() {
        ...
        $mod = model('tps_online/domestik_inbound_model');
        ...
        $this->load->view('backend/pages/tps_online/domestik_inbound/listview', $data);
    }
    ...
    public function view($id = NULL) {
        ...
        if (!$grid_state) {
            $grid_state = 'tps_online/domestik_inbound/listview';
        }
        ...
        if ($row = $mod->get($id)) {
            ...
            $this->load->view('backend/pages/tps_online/domestik_inbound/view', $view);
        } else {
            redirect('tps_online/domestik_inbound/listview/404');
        }
    }
    ...
    public function finalize($id = NULL) {
        ...
        $mod = model('tps_online/domestik_inbound_model');
        $kargo = model('tps_online/cargo_domestik_inbound_model');
        ...
        if ($row = $mod->get($id)) {
            ...
            $this->load->view('backend/pages/tps_online/domestik_inbound/finalize', $view);
        } else {
            redirect('tps_online/domestik_inbound/listview/404');
        }
    }
