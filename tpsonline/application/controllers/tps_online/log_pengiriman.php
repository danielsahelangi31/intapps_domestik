...
class Log_pengiriman extends CI_Controller {
    ...
    public function index() {
        redirect('tps_online/log_pengiriman/listview');
    }
    ...
    public function listview() {
        ...
        $mod = model('tps_online/log_pengiriman_model');
        ...
        $this->load->view('backend/pages/tps_online/log_pengiriman/listview', $data);
    }
    ...
    public function view($id = NULL) {
        ...
        if (!$grid_state) {
            $grid_state = 'tps_online/log_pengiriman/listview';
        }
        ...
        if ($row = $mod->get($id)) {
            ...
            $this->load->view('backend/pages/tps_online/log_pengiriman/view', $view);
        } else {
            redirect('tps_online/log_pengiriman/listview/404');
        }
    }
    ...
    public function finalize($id = NULL) {
        ...
        $mod = model('tps_online/log_pengiriman_model');
        $kargo = model('tps_online/cargo_log_pengiriman_model');
        ...
        if ($row = $mod->get($id)) {
            ...
            $this->load->view('backend/pages/tps_online/log_pengiriman/finalize', $view);
        } else {
            redirect('tps_online/log_pengiriman/listview/404');
        }
    }
