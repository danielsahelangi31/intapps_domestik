<?php
/** Input Manual Zero Defect
  *	Modul untuk menambahkan input manual zero defect berdasarkan tahun dan terminal
  *
  */
class Zero_defect extends CI_Controller{
	private $local_db;
	...
	public function index(){       
        ...
        redirect('tps_online/zero_defect/listview');       
    ...
    public function listview(){	
        ...
        $mod = model('tps_online/model_zero_defect');
		...
		$this->load->view('backend/pages/tps_online/zero_defect/listview',$data);
	}
    ...
    public function view($id = NULL) {
        ...
        if (!$grid_state) {
            $grid_state = 'tps_online/zero_defect/view';
        }
        ...
        if ($row = $mod->get($id)) {         
            ...
            $this->load->view('backend/pages/tps_online/zero_defect/view', $view);
    ...
    public function get($token = NULL) {
        if ($this->auth->token == $token) {
            ...
            $data = $db->select('PERIODE_BULAN, TAHUN, LQ_GATE_1_BACK_KCY, LQ_GATE_1_QUARANTINE, LQ_GATE_2, LQ_GATE_3, CARGO_DEFECT')->where($where)->get('DASHBOARD_ZERO_DEFECT')->row();
    ...
    public function new() {
        ...
        $view = array(			
            ...
            $this->load->view('backend/pages/tps_online/zero_defect/new', $view);
    ...
    public function finalize($id = NULL, $tahun = NULL, $terminal = NULL, $maker = NULL) {
        ...
        if (!$grid_state) {
            $grid_state = 'tps_online/zero_defect/finalize';
        }
		...
		$cfg = $mod->parseParameter($num_args, $get_args);
         ...
         $terminal = "'$terminal'";
         $maker = "'$maker'";
		 $databm = 'SELECT "id_zero", "PERIODE_BULAN", "TAHUN", "CREATED_DATE", "LQ_GATE_1_BACK_KCY", "LQ_GATE_1_QUARANTINE", "LQ_GATE_2", "LQ_GATE_3", "CARGO_DEFECT", "TERMINAL", "MAKER"
		...
		$out->databm=$databm;
		 ...
		 $view = array(			
            ...
            $this->load->view('backend/pages/tps_online/zero_defect/finalize', $view);
