...
class Kargo_internasional_inbound extends CI_Controller {
    ...
    public function listview() {
        ...
        $mod = model('tps_online/kargo_internasional_inbound_model');
        ...
        // print_r($data);die;
        $this->load->view('backend/pages/tps_online/kargo_internasional_inbound/listview', $data);
    }
    ...
    public function view($id = NULL) {
        ...
        if (!$grid_state) {
            $grid_state = 'tps_online/kargo_internasional_inbound/listview';
        }
        ...
        if ($row = $mod->get($id)) {
            ...
            $this->load->view('backend/pages/tps_online/kargo_internasional_inbound/view', $view);
        } else {
            redirect('tps_online/kargo_internasional_inbound/listview/404');
        }
    }
