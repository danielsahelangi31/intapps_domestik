<?php
error_reporting(0);
class Kargolist extends CI_Controller{
	private $local_db;
	...
	public function listview($id){	
		...
		$mod = model('tps_online/kargolist_model');
		...
		$cfg->pagingURL = 'tps_online/kargolist/listview/'.$id;
		//print_r ($cfg);
		//die;
		...
		$this->load->view('backend/pages/tps_online/kargolist/listview', $data);
	}
	...
	public function view($id = NULL){
		...
		if(!$grid_state){
			$grid_state = 'tps_online/kargolist/listview';
		}
		...
		if($row = $mod->get($id)){
			...
			$this->load->view('backend/pages/tps_online/kargolist/view', $view);
		}else{
			redirect('tps_online/kargolist/listview/404');
		}
	}
	...
	public function edit($id = NULL){
		...
		if($row = $mod->get($id)){
			...
			$this->load->view('backend/pages/tps_online/kargolist/edit', $view);
		}else{
			redirect('tps_online/kargolist/listview/404');
		}
	}
