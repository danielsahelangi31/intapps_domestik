...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo site_url('vessel/dashboard_vessel') ?>" style="padding:10px 20px 8px 10px"><img src="<?php echo base_url('assets/img/smartcargo/int_logo.png') ?>" alt="SmartCargo" /></a>
        </div>
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                if ($auth->administrator_id) {
                    ...
                    if (in_array('BEACUKAI', $roles)) {
                        ...
                        ?>
                        <li>
                            <a href="<?php echo site_url('vessel/vessel_list') ?>">Vessel</a>
                        </li>
                        <?php
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo site_url('vessel/dashboard_vessel/passwordUpdateVessel') ?>">Ganti Password</a></li>
