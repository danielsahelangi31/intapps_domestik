		...
		<div class="container">
			...
			<div class="alert alert-danger fade in">
				...
				<p>
					...
					<a href="<?php echo site_url('manifest/manifest_upload/add') ?>" class="btn btn-default">Mulai Lagi Dari Awal</a>
				</p>
			</div>
			<?php
			}
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="pull-right">
						...
						<a class="btn btn-default fr" href="<?php echo site_url('manifest/manifest_upload') ?>">Kembali</a>
					</div>
				</div>
			</div>
			<?php echo form_close() ?>
