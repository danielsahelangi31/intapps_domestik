...
?>
	<div id="wrap">
		...
		<div class="container">
             ...
             <h1 style="margin-bottom:25px;margin-left:-25px">Laporan Trafik/Arus Barang</h1>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
            ...
            $('#simpan').click(function(e){
                ...
                var urls = bs.baseURL + 'tps_online/lap_arus_barang/export_laporan_xls/'+start+'/'+end
                console.log('end',end)
                console.log('terminal',terminal)
                console.log('url',urls)
                e.preventDefault(); 
                if (terminal == 'DOM'){
                    window.location.href = bs.baseURL + 'tps_online/lap_arus_barang/export_laporan_xls/'+start+'/'+end+'/'+terminal;
                }else if (terminal == 'INT') {
                    window.location.href = bs.baseURL + 'tps_online/lap_arus_barang/export_laporan_intr/'+start+'/'+end+'/'+terminal;
                }
