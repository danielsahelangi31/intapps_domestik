...
<body>
	<div id="wrap">
		...
		<div class="container">
			...
			<div class="row">
            	<div class="col-md-8">
                	<h2>Edit Data Kunjungan Kapal</h2>
                </div>
				<div class="col-md-4">
			...
			<div class="row">
				<div class="col-lg-6">
					...
					<!--<a href="<?php echo site_url('tps_online/kunjungan_kapal/finalize/'.$kunjungan->VISIT_ID) ?>" class="btn btn-success"><span class="glyphicon glyphicon-check"></span> Finalize Visit</a>-->
					<a href="<?php echo site_url('tps_online/kargo/listview/sf:VISIT_ID/kw:'.$kunjungan->VISIT_ID) ?>" class="btn btn-success"><span class="glyphicon glyphicon-list-alt"></span> Lihat Daftar Kargo</a>
