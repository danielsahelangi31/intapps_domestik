...
?>
	<div id="wrap">
		...
		<div class="container">
             ...
             <h1 style="margin-bottom:25px;margin-left:-25px">Laporan Produksi dan Pendapatan per Pusat Layanan</h1>
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="d-flex justify-content-left">
                        ...
                        <div class="form-group" style="margin-left:0px;width:48.5%;"> 
                         ...
                         <div class="form-group" style="margin-left:0px;width:48.5%;"> 
                                <label>Tipe<b class="text-danger">*</b></label>
                                <select class="form-control" name="TIPE" id="TIPE">
                                    <option value="">-- PILIH --</option>
                                    <option value="PER TAHUN">PER TAHUN</option>
                                    <option value="PER SEMESTER">PER SEMESTER</option>                                    
                                    <option value="PER TRIWULAN">PER TRIWULAN</option>  
                                </select> 
							</div>                   
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
            ...
            $('#simpan').click(function(e){
                ...
                if(!param.TIPE || param.TIPE == ""){
					$('#TIPE').parent().addClass('has-error');
					add_validation_popover('#TIPE', 'TIPE Harus dipilih');
                ...
                var urls = bs.baseURL + 'tps_online/lap_pendapatan/export_pendapatan_xls/'+start+'/'+end
                console.log('end',end)             
                ...
                e.preventDefault(); 
                if (terminal == 'DOM'){
                    window.location.href = bs.baseURL + 'tps_online/lap_pendapatan/export_pendapatan_dom/'+start+'/'+end+'/'+tipe;
                }else if (terminal == 'INT') {
                    window.location.href = bs.baseURL + 'tps_online/lap_pendapatan/export_pendapatan_xls/'+start+'/'+end+'/'+tipe;
                }
                }
                return false;
			});
