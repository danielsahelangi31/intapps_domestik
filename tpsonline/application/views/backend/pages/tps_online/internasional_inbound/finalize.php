    ...
    <body>
        <div id="wrap">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <h2>Finalize Data Kunjungan Kapal Import</h2>
                    </div>
                    <div class="col-md-4">
                                ...
                                <tbody>
                                    ...
                                    foreach ($unsent as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo site_url('tps_online/kargo_internasional_inbound/view/' . $row->VIN) ?>" class="edit_link">Lihat</a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <a href="<?php echo site_url('tps_online/internasional_inbound/view/' . $kunjungan->VISIT_ID) ?>" class="btn btn-success"><span class="glyphicon glyphicon-folder-open"></span> Lihat Data Kunjungan</a>
                    ...
                    <div class="col-lg-6">
                        <div class="pull-right">
                            ...
                            <a href="<?php echo site_url('tps_online/internasional_inbound/listview') ?>" class="btn btn-default">Kembali</a>
                        </div>
                    </div>
                </div>
                <?php echo form_close() ?>
