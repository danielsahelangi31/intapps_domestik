...
<body>
	<div id="wrap">
		...
		<div class="container">
			...
			<h1 style="margin-bottom:25px;margin-left:-25px">ACTIVITY BM</h1>
            ...
            <div class="d-flex justify-content-left">
                    ...
                    <table class="table table-striped table-condensed" id="dt_tabel">
                        <thead>
                            <tr>                      
                                ...
                                <th><?php echo gridHeader('PBM', 'PBM', $cfg) ?></th>
                        ...
                        <tbody>
                            <?php
                             $grid_state = 'tps_online/form_dom/finalize/p:1';
                               ...
                               if($databm){                          
                                foreach($databm as $row){
                                    ...
                                    <tr>                                 
                                        ...
                                        <td>
                                        <a href="<?php echo site_url('tps_online/form_dom/view/' . $row->ID_MONITORING_HEADER . '/' . $grid_state) ?>" class="edit_link">Edit</a>                                           
                    ...
                    <div class="form-group col-md-6" style="margin-top:10px;margin-left:0px">                             
                                    <a href="<?php echo site_url('tps_online/form_dom/listview') ?>" class="btn btn-primary">Kembali</a>             
                              </div>
