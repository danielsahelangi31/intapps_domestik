                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
							<div class="form-group" style="margin-right:0px">
                                ...
                                <input type="text" class="form-control right" readonly id="PBM" name="PBM" value="<?php echo $kunjung->PBM ?>"/>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
							<div class="form-group" style="margin-right:0px">
	...
	$(document).ready(function(){
        ...
        if(param.ACTIVITY == 'COMPLETE OPERATION' || param.ACTIVITY == 'CLOSE RAMPDOOR' ||  param.ACTIVITY == 'WAITING CLEARANCE DOCS'){
				...
				if(is_error){
					...
					var urls = bs.siteURL + 'FormDetail/update/' + bs.token;
                    console.log('url',urls)                 
       
					$.post(urls, param, function(data){
                        $.notify("Data berhasil ditambahkan", "success");
                        window.location.href = bs.siteURL + 'tps_online/form_dom/listview';   
					    $('#simpan_load').hide();
