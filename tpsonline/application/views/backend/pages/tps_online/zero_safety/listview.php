                        ...
                        <div class="card rounded-0 shadow" style="width: 200%;">
                            ...
                            <form>              
                                ...
                                <div class="form-group col-md-6" style="margin-top:5px;margin-left:0px;width:100%">
                                   ...
                                   <a href="<?php echo site_url('tps_online/zero_safety/listview') ?>" class="btn btn-warning">Reset</a>  
                                   <hr /> 
                                </div>
                    ...
                    <table class="table table-striped table-condensed">
                        <thead>
                            <tr>                   
                                ...
                                <th style="text-align: center"><?php echo gridHeader('ACCIDENT', 'Accident', $cfg) ?></th>                            
                                <th style="text-align: center"><?php echo gridHeader('INSIDENT', 'Incident', $cfg) ?></th>
                                <th style="text-align: center"><?php echo gridHeader('UNIT_IMPACT', 'Unit Impact', $cfg) ?></th>                   
                        ...
                        <tbody>
                            <?php                 
                           $grid_state = 'tps_online/zero_safety/listview/p:1';                      
                               ...
                               if($datazero){    
                                 foreach($datazero as $row){
                                    ...
                                    <tr>  
                                        ...
                                        <td style="text-align: center"><?php echo $row['accident']?></td>                              
                                        <td style="text-align: center"><?php echo $row['incident']?></td>                              
                                        <td style="text-align: center"><?php echo $row['unit_impact'] ?></td>                          
        
                                        <td style="text-align: center">                                            
                                            <a href="<?php echo site_url('tps_online/zero_safety/finalize/'.$row['periode_bulan']. '/' .$row['tahun'] . '/' .$row['terminal'] . '/'  .$row['maker'] . '/'. $grid_state) ?>" class="edit_link">Activity</a>                                            
                                        </td> 
                                    </tr>
                                    <?php
                                }
...
$(document).ready(function(){
    ...
    $('#simpan').click(function(e){
            ...
            var param = {                      
                    ...
                    var urls = bs.siteURL + 'tps_online/zero_safety/listvieww/'+terminal+'/'+tahun+'/'+periode + '/'+maker+'/';
                    console.log('url', urls)
                    e.preventDefault(); 
                    
                    if (terminal != ''){                     
                        window.location.href = bs.siteURL + 'tps_online/zero_safety/listview1/'+terminal;                       
                   
                    } else if (periode != ''){
                        window.location.href = bs.siteURL + 'tps_online/zero_safety/listview2/'+periode;    
                    } else if (tahun != ''){
                        window.location.href = bs.siteURL + 'tps_online/zero_safety/listview3/'+tahun;    
                    } else if (maker != ''){
                        window.location.href = bs.siteURL + 'tps_online/zero_safety/listview4/'+maker; 
                    }

                    if (terminal != '' && periode != ''){
                        window.location.href = bs.siteURL + 'tps_online/zero_safety/listview5/'+terminal+'/'+periode;    
                    } else if (terminal != '' && tahun != ''){
                        window.location.href = bs.siteURL + 'tps_online/zero_safety/listview6/'+terminal+'/'+tahun;    
                    } else if (terminal != '' && maker != ''){
                        window.location.href = bs.siteURL + 'tps_online/zero_safety/listview7/'+terminal+'/'+maker;    
                    } else if (periode != '' && tahun != ''){
                        window.location.href = bs.siteURL + 'tps_online/zero_safety/listview8/'+periode+'/'+tahun;    
                    } else if (periode != '' && maker != ''){
                        window.location.href = bs.siteURL + 'tps_online/zero_safety/listview9/'+periode+'/'+maker;    
                    } else if (tahun != '' && maker != ''){
                        window.location.href = bs.siteURL + 'tps_online/zero_safety/listview10/'+tahun+'/'+maker;    
                    }

                    if (terminal != '' && periode != '' && tahun != ''){
                        window.location.href = bs.siteURL + 'tps_online/zero_safety/listview11/'+terminal+'/'+periode+'/'+tahun;    
                    } else if (terminal != '' && periode != '' && maker != ''){
                        window.location.href = bs.siteURL + 'tps_online/zero_safety/listview12/'+terminal+'/'+periode+'/'+maker;    
                    } else if (terminal != '' && tahun != '' && maker != ''){
                        window.location.href = bs.siteURL + 'tps_online/zero_safety/listview13/'+terminal+'/'+tahun+'/'+maker;    
                    } else if (periode != '' && tahun != '' && maker != ''){
                        window.location.href = bs.siteURL + 'tps_online/zero_safety/listview14/'+periode+'/'+tahun+'/'+maker;  
                    }

                    if (terminal != '' && periode != '' && tahun != '' && maker != ''){
                        window.location.href = bs.siteURL + 'tps_online/zero_safety/listview15/'+terminal+'/'+periode+'/'+tahun+'/'+maker;      
                    }
