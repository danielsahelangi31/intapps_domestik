...
<body>
            ...
            <div class="d-flex justify-content-left">
                    <div class="col-md-6">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            ...
                            <input type="text" class="form-control" readonly id="NAMA_KAPAL" name="NAMA_KAPAL" value="<?php echo $vesel->VISIT_NAME;?>"/>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            ...
                            <input type="text" class="form-control" readonly id="KADE_DERMAGA" name="KADE_DERMAGA" value="<?= $vesel->POSITION_CODE; ?>"/>
                            </div>
                        </div>
						...
						<div class="form-group" style="margin-left:-15px;width:50%;"> 
                             ...
                             <input type="text" class="form-control" readonly id="VOYAGE" name="VOYAGE" value="<?php echo $vesel->VOYAGE_IN; ?>"/>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            ...
                            <input type="datetime-local" class="form-control right" id="ETB" name="ETB" value="<?php echo $ETBH; ?>"/>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
							<div class="form-group" style="margin-right:0px">
    ...
    function setVisitID(id, voyage){
        document.location="<?php echo site_url('tps_online/form_intr/neww');?>"+"?id="+id+"&voyage="+voyage+"";
    }
		...
		if(param.ACTIVITY == 'COMPLETE OPERATION' || param.ACTIVITY == 'CLOSE RAMPDOOR' ||  param.ACTIVITY == 'WAITING CLEARANCE DOCS'){
            if(!param.NAMA_KAPAL || param.NAMA_KAPAL == ""){
				...
				if(is_error){
					...
					var urls = bs.siteURL + 'FormIntr/simpan/' + bs.token;
			...
			function reset_form(){
				console.log('reset',)
				$('#NAMA_KAPAL, #POSITION_CODE, #VOYAGE_IN, #RENCANA_BONGKAR, #RENCANA_MUAT, #ETA, #ATA, #ATB, #ETD, #ATD, #COMMENCE, #COMPLETE, #SHIFT, #ACTIVITY, #TIME_START, #TIME_END, #REALISASI_BONGKAR, #REALISASI_MUAT').val('');
			}
