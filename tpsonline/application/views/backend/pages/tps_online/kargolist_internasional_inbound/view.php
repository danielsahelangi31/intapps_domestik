                ...
                <fieldset class="delivery-request-border">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label class="col-lg-4 control-label">BC 11 Number</label>
                                <div class="col-lg-8">
                                    <p class="form-control-static" id="INWARD_BC11"><?php echo $kargo->INWARD_BC11 ?></p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-4 control-label">BC 11 Date</label>
                                <div class="col-lg-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <p class="form-control-static" id="CUSTOMER"><?php echo $kargo->CUSTOMER ?></p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-4 control-label">Carrier</label>
                                <div class="col-lg-8">
                                    <p class="form-control-static" id="CARRIER"><?php echo $kargo->CARRIER ?></p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-4 control-label">Vessel Call Sign</label>
                                <div class="col-lg-8">
                                    <p class="form-control-static" id="VESSEL_CALL_SIGN"><?php echo $kargo->VESSEL_CALLSIGN ?></p>
                                </div>
                            </div>
                        </div>
