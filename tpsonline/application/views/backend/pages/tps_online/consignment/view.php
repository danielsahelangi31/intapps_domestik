...
<body>
	<div id="wrap">
		...
		<div class="container">
								...
								<table class="table table-bordered table-striped">
									<tbody>
										...
										<tr>
											...
											<td>File Unggahan</td>
											<td><a href="<?php echo site_url('tps_online/kunjungan_kapal/unduh_manifest/'.$manifest->id) ?>"><?php echo $manifest->nama_file_asli ?></a></td>
										</tr>
										<tr>
			...
			<div class="row">
				<div class="col-lg-6">
					<a href="<?php echo site_url('tps_online/kunjungan_kapal/unduh_manifest/'.$manifest->id) ?>" class="btn btn-primary"><span class="glyphicon glyphicon-download"></span> Unduh Manifest</a>
				</div>
				<div class="col-lg-6">
