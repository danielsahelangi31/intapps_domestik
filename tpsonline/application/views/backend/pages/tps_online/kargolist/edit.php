				...
				<div class="row">
					<div class="col-lg-6">
						...
						<div class="form-group">
							...
							<label class="col-lg-4 control-label">No. PEB</label>
							<div class="col-lg-8">
						...
						<div class="form-group">
							<label class="col-lg-4 control-label">Tanggal PEB</label>
							<div class="col-lg-8">
		...
		$(document).ready(function(){
			...
			$('#simpan').click(function(){
				...
				if(is_error){
					...
					var url = bs.siteURL + 'tps_online/kargolist/update/' + bs.token;
