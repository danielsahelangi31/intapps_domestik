				...
				<table class="table table-striped table-condensed">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="<?php echo site_url('tps_online/kargolist/view/'.$row->VIN.'/'.$grid_state) ?>" class="edit_link">Lihat</a>
								<a href="<?php echo site_url('tps_online/kargolist/edit/'.$row->VIN.'/'.$grid_state) ?>" class="edit_link">Edit</a>
							</td>
						</tr>
						<?php
							}
