...
<body>
	...
	$(document).ready(function(){
		 let url = bs.siteURL + 'tps_online/notifikasi/get_data_export/' + bs.token;
            ...
            "aoColumns": [
		        { 
		        	...
		        	"render": function(data,type,row,meta){
		        		if (type == 'display') {
		        			data = "<a href='"+bs.siteURL+"tps_online/notifikasi/view_export/"+ data + "'>" + data + "</a>";
		        		}
		        		return data;
		        	}
		    	},
