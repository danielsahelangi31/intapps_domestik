...
<body>
            ...
            <div class="d-flex justify-content-left">
                    <div class="col-md-6">
                        ...
                        <div class="btn"  id="simpan_load" style="display:auto;margin-left:0%">                     
							<a href=""  class="btn btn-primary" id="update_trafik">Simpan</a>
	...
	$(document).ready(function(){
        ...
        $('#update_trafik').click(function(){
      
                id = <?php echo $kunjung->id_trafik ?>;
				var param = {   
                    'id_trafik' : id,
				...
				if(is_error){
					...
					var urls = bs.siteURL + 'FormTrafik/update_trafik/' + bs.token;
