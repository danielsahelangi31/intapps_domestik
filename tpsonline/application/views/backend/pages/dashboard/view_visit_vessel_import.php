...
?>
	<div id="wrap">
		...
		<div class="container">
			...
			<h1>Detail Visit Vessel Import</h1>
			<p class="lead">
				<small></small>
			</p>
			<hr>
				...
				<div class="col-md-12">
					<div class="table-responsive">
						<table class="table table-striped table-condensed" id="dt_tabel">
							...
							<tbody>
								<?php foreach ($visit_vessel_import as $row) { ?>
								<tr>
									...
									<td>
										<a href="<?php echo site_url('DashboardReal/vin_detail_vessel_out/' . $row->VISIT_ID.'/') ?>" class="edit_link">
										<?= $row->JML_VIN ?>
									</td>
								</tr>
								<?php } ?>
