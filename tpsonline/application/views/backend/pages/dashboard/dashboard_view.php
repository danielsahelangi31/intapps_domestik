...
<script type="text/javascript" language="JavaScript">
	...
	var url2 = "http://10.15.41.162:80/Streaming/Channels/1/picture?time="; //setting halaman awal pada saat dibuka
	...
	{
		var unique = new Date();
		document.images.webcam2.src = newImage2.src;
		newImage2.src = url2 + unique.getTime();
	}
	...
	function InitialImage2()
	{
		var unique = new Date();
		newImage2.onload = LoadNewImage2;
		newImage2.src =  url2 + unique.getTime();
	...
	{	var unique = new Date();
		...
		newImage2.src = url2 + unique.getTime() ;
						...
						<img src="http://10.15.41.161:80/Streaming/Channels/1/picture" id="cctv" name="webcam" onload="InitialImage()" width="100%" alt="Maaf ... Sedang ada gangguan ...">
						<img src="http://10.15.41.162:80/Streaming/Channels/1/picture" id="cctv2" name="webcam2" onload="InitialImage2()" width="100%" alt="Maaf ... Sedang ada gangguan ...">
...
$(document).ready(function(){
	...
	function lookup_data_sum(){
		...
		setInterval(lookup_data_sum, 1000);
	}
