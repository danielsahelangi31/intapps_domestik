									...
									<tbody>
										...
										<tr>
											...
											<td>
													...
													<input type="text" class="form-control trucking-contact tval TM_TRUCKING_COMPANY" name="trucking_company[<?php echo $row->id ?>]" placeholder="Ketik Perusahaan Angkutan" />
