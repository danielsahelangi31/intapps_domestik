						...
						<div class="form-group">
							...
							<div class="col-lg-8">
								<p class="form-control-static">
									<?php 
									echo date('d-F-Y', strtotime($trucking_request->rencana_ambil));
									
									$hari = (strtotime($trucking_request->rencana_ambil) - time());
									$time_left = explode(':', date('j:H', $hari));
									
									?>
									(<?php echo $time_left[0].' hari '.($time_left[1] ? $time_left[1].' jam' : '') ?> lagi)
								</p>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-8">
								<p class="form-control-static"><?php echo $trucking_request->consignee ?></p>
							</div>
						</div>
					</fieldset>
				</div>
							...
							<table class="table table-bordered">
								<tbody>
									<tr>
										...
										<td><input type="text" class="form-control" id="nama_supir" name="nama_supir" autocomplete="off" value="<?php echo post('nama_supir') ? post('nama_supir') : $trucking_request->nama_supir ?>" ></td>
									</tr>
									<tr>
										<td><label class="text-left">Truck ID / No. Polisi</label></td>
										<td><input type="text" class="form-control" id="truck_id" name="truck_id" value="<?php echo post('truck_id') ? post('truck_id') : $trucking_request->truck_id ?>" ></td>
									</tr>
									<tr>
										...
										<td>
											<div class="input-group">
												...
												<input type="text" class="form-control" id="nomor_handphone" name="nomor_handphone" value="<?php echo post('nomor_handphone') ? post('nomor_handphone') : $trucking_request->nomor_handphone ?>" />
											</div>
