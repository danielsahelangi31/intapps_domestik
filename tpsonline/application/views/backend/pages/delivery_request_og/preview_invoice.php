								...
								<div id="detail_wrap">
									<table id="invoice_detail_table">
										...
										<tr class="item">
											...
											<td class="center"><?php echo $detail->tglAwal ? date('d-M-Y', strtotime($detail->tglAwal)) : '' ?>&nbsp;</td>
											<td class="center"><?php echo $detail->tglAwal ? date('d-M-Y', strtotime($detail->tglAkhir)) : '' ?>&nbsp;</td>
											<td class="center"><?php echo $detail->qty ?>&nbsp;</td>
											<td class="center"><?php echo $detail->sizeCont ?>&nbsp;</td>
											<td class="center"><?php echo $detail->styName ?>&nbsp;</td>
											<td class="center"><?php echo $detail->nmJenisPemilik ?>&nbsp;</td>
											<td class="center"><?php echo $detail->hazard ? 'Y' : 'T' ?>&nbsp;</td>
											<td class="right"><?php echo ($detail->totalHari) ?>&nbsp;</td>
